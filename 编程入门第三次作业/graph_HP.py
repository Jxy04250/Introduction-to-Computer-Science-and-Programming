...
##--- 第0步：准备工作
# 输入文件
node_file_name = './data/HP-人物节点.csv'
link_file_name = './data/HP-人物连接.csv'
# 输出文件
out_file_name = './output/关系图-HP.html'
...
c.set_global_opts(title_opts=opts.TitleOpts(title="关系图-哈利波特人物"))
